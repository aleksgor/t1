...
public class TestIdGeneratorDataBase extends CommonTest {
    ...
    public static void start() throws Exception {
        try {
            host = "localhost";
            commonSetup();
            final String[] files = { "configuration/idgenerator/database/cacheManager.xml", "configuration/idgenerator/database/cache1.xml", "configuration/idgenerator/database/cache2.xml",
                    "configuration/idgenerator/database/cache3.xml", "configuration/idgenerator/database/cache4.xml" };
