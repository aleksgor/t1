...
public class NoIdTestModel implements Model {
    ...
    private byte[] blob;
    private NoIdTestModelId identifier;
    private double money;


    public NoIdTestModel() {
        super();
    }
    ...
    public NoIdTestModel(NoIdTestModelId identifier) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        NoIdTestModel other = (NoIdTestModel) obj;
    ...
    public String toString() {
        return "NoIdTestModel [id=" + id + ", name=" + name + ", date=" + date + ", childId=" + childId + ", secondChildId=" + secondChildId + ", thirdChildId=" + thirdChildId
                + ", child=" + child + ", secondChild=" + secondChild + ", thirdChild=" + thirdChild + ", blob=" + Arrays.toString(blob) + ", identifier=" + identifier
                + ", money=" + money + "]";
    }
