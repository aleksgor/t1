...
public class SessionDataInvoker extends BaseDataInvoker implements DataInvoker {
    ...
    public void init(Properties properties, ServerContext context, String connectName) throws SystemException {
        ...
        dataInvoker = (PmDataInvoker) context.getPmDataInvoker(connectName);
        if (dataInvoker == null) {
    ...
    public Model addModel(Model m) throws SystemException {

        return dataInvoker.addModel(Arrays.asList(m)).iterator().next();
    }
