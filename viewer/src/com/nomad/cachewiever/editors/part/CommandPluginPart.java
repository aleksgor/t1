...
import com.nomad.cachewiever.editors.figure.CommandPluginFigure;
...
public class CommandPluginPart extends AppAbstractEditPart implements NodeEditPart{
  @Override
  protected IFigure createFigure() {
    IFigure figure = new CommandPluginFigure((CommandPluginNode) getModel());
    return figure;
  }
  ...
  protected void refreshVisuals() {
    CommandPluginFigure figure = (CommandPluginFigure) getFigure();
    CommandPluginNode model = (CommandPluginNode) getModel();
  ...
  public List<Connection> getModelSourceConnections() {
    return ((CommandPluginNode)getModel()).getSourceConnectionsArray();
  }
  
  public List<Connection> getModelTargetConnections() {
    return ((CommandPluginNode)getModel()).getTargetConnectionsArray();
  }
