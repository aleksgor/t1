...
import com.nomad.cachewiever.editors.figure.DataSourceFigure;
...
public class DataDourcePart extends AppAbstractEditPart implements NodeEditPart{
  @Override
  protected IFigure createFigure() {
    IFigure figure = new DataSourceFigure((DataSourceNode) getModel());
    return figure;
  }
...
//    installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new AppConnectionPolicy());    
  ...
  protected void refreshVisuals() {
    ...
    DataSourceNode model = (DataSourceNode) getModel();
  ...
  public List<Connection> getModelSourceConnections() {
    return ((DataSourceNode)getModel()).getSourceConnectionsArray();
  }
  
  public List<Connection> getModelTargetConnections() {
    return ((DataSourceNode)getModel()).getTargetConnectionsArray();
  }
