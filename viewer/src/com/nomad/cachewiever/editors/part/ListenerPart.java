...
import com.nomad.cachewiever.editors.figure.ListenerFigure;
...
public class ListenerPart extends AppAbstractEditPart implements NodeEditPart{
  @Override
  protected IFigure createFigure() {
    IFigure figure = new ListenerFigure((ListenerNode) getModel());
    return figure;
  }

  public ListenerModel getListenerModel(){
    return ((ListenerFigure)getFigure()).getListenerModel();
  }
  ...
  public void refreshVisuals() {
    ListenerFigure figure = (ListenerFigure) getFigure();
    ListenerNode model = (ListenerNode) getModel();
  ...
  public List<Connection> getModelSourceConnections() {
    return ((ListenerNode)getModel()).getSourceConnectionsArray();
  }
  
  public List<Connection> getModelTargetConnections() {
    return ((ListenerNode)getModel()).getTargetConnectionsArray();
  }
