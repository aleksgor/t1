...
import com.nomad.cachewiever.editors.figure.StoreModelFigure;
...
public class StoreModelPart extends AppAbstractEditPart implements NodeEditPart{
  @Override
  protected IFigure createFigure() {
    IFigure figure = new StoreModelFigure((StoreModelNode) getModel());
    return figure;
  }
  ...
  protected void refreshVisuals() {
    StoreModelFigure figure = (StoreModelFigure) getFigure();
    StoreModelNode model = (StoreModelNode) getModel();
  ...
  public List<Connection> getModelSourceConnections() {
    return ((StoreModelNode)getModel()).getSourceConnectionsArray();
  }
  
  public List<Connection> getModelTargetConnections() {
    return ((StoreModelNode)getModel()).getTargetConnectionsArray();
  }
