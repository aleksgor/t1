package com.nomad.cachewiever.views.layout;
...
public class BorderLayout extends Layout {
	...
	protected void layout(Composite composite, boolean flushCache) {
		...
		if (controls[EAST] != null) {
			controls[EAST].setBounds(clientArea.x + clientArea.width - sizes[EAST].x, clientArea.y + sizes[NORTH].y, sizes[EAST].x, clientArea.height
					- sizes[NORTH].y - sizes[SOUTH].y);
		}
		if (controls[CENTER] != null) {
			controls[CENTER].setBounds(clientArea.x + sizes[WEST].x, clientArea.y + sizes[NORTH].y, clientArea.width - sizes[WEST].x - sizes[EAST].x,
