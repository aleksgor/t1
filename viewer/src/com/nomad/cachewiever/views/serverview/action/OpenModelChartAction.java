...
public class OpenModelChartAction implements IAction {
  ServerView viewer;
  public OpenModelChartAction(ServerView viewer) {
    this.viewer = viewer;
  }
  ...
  public void runWithEvent(Event event) {
    ...
    try {
      OpenViewUtilite.openModelChartView(server);
    } catch (Exception e) {
      e.printStackTrace();
    }
