...
import com.nomad.communication.nio.MessageLength;
import com.nomad.communication.nio.TwoByteMessageLength;
...
public class TwoByteMessageLengthTest {
    ...
    private void assertArrayEquals(final byte[] arr1, final byte[] arr2) {
